...
class PurchaseOrder(models.Model):
    ...
    def _compute_amounts(self):
        # NOTE: purchase.order historically used `_amount_all` instead of
        # `_compute_amounts`. Check `self.env['purchase.order']._fields['amount_total'].compute`
        # in shell — rename this method to match if needed.
