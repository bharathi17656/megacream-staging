...
class HrPayslip(models.Model):
    ...
    def compute_sheet(self):
        ...
        for payslip in self:
            ...
            # ─────────────────────────────────────────────
            # 2️⃣ Define working days per group
            # ─────────────────────────────────────────────
            def is_sunday(d):
                return d.weekday() == 6
            ...
            if sunday_compensated:
                lines.append({
                    'name': 'Sunday Compensated',
                    'code': 'LOPCOMP',
                    'number_of_days': sunday_compensated,
