{
    ...
    "data": [
        ...
        "views/daily_report_server_action.xml",
        "views/monthly_attendance_wizard_view.xml",
        "views/monthly_report_server_action.xml",
        "reports/monthly_attendance_template.xml",
